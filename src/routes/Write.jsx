    ...
    return (
        <div className='h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6'>
            ...
            <form className='flex flex-col gap-6 flex-1 mb-6'>
                ...
                <input className='text-4xl font-semibold bg-transparent outline-none' type="text" placeholder='My Cringe Story' />
                <div className='flex items-center gap-4'>
                    <label htmlFor="" className='text-sm'>Choose a category:</label>
                    <select name="cat" id="" className='p-2 rounded-xl bg-[rgba(53,53,53,1)] shadow-md'>
                ...
                <ReactQuill theme="snow" className='flex-1 rounded-xl bg-[rgba(53,53,53,1)] shadow-md text-white' />
